...
- (void)toggleMsg:(SASToggleMessage*)input error:(FlutterError**)error {
...
- (SASIsEnabledMessage*)isEnabledWithError:(FlutterError* __autoreleasing *)error {
  NSNumber *enabled = [NSNumber numberWithBool:[[UIApplication sharedApplication] isIdleTimerDisabled]];
    SASIsEnabledMessage* result = [[SASIsEnabledMessage alloc] init];
